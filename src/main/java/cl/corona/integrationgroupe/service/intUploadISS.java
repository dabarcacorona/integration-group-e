...
public class intUploadISS {
    ...
    @Value("${sftpdcmx.dst_ISS}")
    private String d_sftpdtn_ISS;
                ...
                switch (sSubCadena) {
                    ...
                    case "CMX":
                        if (file.isFile()) {
                            ...
                            LOG.info("Uploading CMX_ASN " + filename + " ---> " + d_sftpdtn_ISS);
                            d_sftp.put(filename, d_sftpdtn_ISS);
                            file.delete();
